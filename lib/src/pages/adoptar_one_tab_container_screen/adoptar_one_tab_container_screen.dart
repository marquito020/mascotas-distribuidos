...
import 'package:adopet_app/src/pages/adoptar_one_page/adoptar_ave_page.dart';
import 'package:adopet_app/src/pages/adoptar_one_page/adoptar_gato_page.dart';
/* import 'package:adopet_app/presentation/favoritos_one_page/favoritos_one_page.dart'; */
import 'package:adopet_app/src/pages/adoptar_one_page/adoptar_otro_page.dart';
import 'package:adopet_app/src/pages/adoptar_one_page/adoptar_perro_page.dart';
...
class AdoptarPage extends StatefulWidget {
  const AdoptarPage({Key? key})
      : super(
          key: key,
        );

  @override
  AdoptarPageState createState() => AdoptarPageState();
}

class AdoptarPageState extends State<AdoptarPage>
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              ...
              child: Text(
                "¿Tienes un animal que necesita de un hogar?\nRegistralo aquí",
                maxLines: 3,
        ...
        tabs: [
          ...
          Tab(
            child: Container(
              ...
              /* decoration: AppDecoration.gradientBlueToBlue50001.copyWith(
                borderRadius: BorderRadiusStyle.circleBorder15,
              ), */
              child: Container(
                width: 45.h,
