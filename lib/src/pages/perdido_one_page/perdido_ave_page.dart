...
class PerdidoAveList extends StatefulWidget {
  const PerdidoAveList({Key? key})
      : super(
          key: key,
        );

  @override
  PerdidoAveListState createState() => PerdidoAveListState();
}

class PerdidoAveListState extends State<PerdidoAveList>
    with AutomaticKeepAliveClientMixin<PerdidoAveList> {
  @override
  bool get wantKeepAlive => true;
  List<Perdido> perdidoListAve = [];
  @override
  Widget build(BuildContext context) {
    ...
    perdidoListAve = perdidoService.perdidoAveList;
    print(perdidoListAve.length);
    super.build(context);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GridView.builder(
                    ...
                    itemCount: perdidoListAve.length,
                    itemBuilder: (context, index) {
                      return FavoritosoneItemWidget(
                        perdido: perdidoListAve[index],
                      );
                    },
                  ),
                ),
