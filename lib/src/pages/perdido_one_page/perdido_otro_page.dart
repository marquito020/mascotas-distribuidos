...
class PerdidoOtrosList extends StatefulWidget {
  const PerdidoOtrosList({Key? key})
      : super(
          key: key,
        );

  @override
  PerdidoOtrosListState createState() => PerdidoOtrosListState();
}

class PerdidoOtrosListState extends State<PerdidoOtrosList>
    with AutomaticKeepAliveClientMixin<PerdidoOtrosList> {
  @override
  bool get wantKeepAlive => true;
  List<Perdido> perdidoListOtro = [];
  @override
  Widget build(BuildContext context) {
    ...
    perdidoListOtro = perdidoService.perdidoOtroList;
    print(perdidoListOtro.length);
    super.build(context);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GridView.builder(
                    ...
                    itemCount: perdidoListOtro.length,
                    itemBuilder: (context, index) {
                      return FavoritosoneItemWidget(
                        perdido: perdidoListOtro[index],
                      );
                    },
                  ),
                ),
