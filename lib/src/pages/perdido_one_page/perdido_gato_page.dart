...
class PerdidoGatoList extends StatefulWidget {
  const PerdidoGatoList({Key? key})
      : super(
          key: key,
        );

  @override
  PerdidoGatoListState createState() => PerdidoGatoListState();
}

class PerdidoGatoListState extends State<PerdidoGatoList>
    with AutomaticKeepAliveClientMixin<PerdidoGatoList> {
  @override
  bool get wantKeepAlive => true;
  List<Perdido> perdidoListGato = [];
  @override
  Widget build(BuildContext context) {
    ...
    perdidoListGato = perdidoService.perdidoGatoList;
    print(perdidoListGato.length);
    super.build(context);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GridView.builder(
                    ...
                    itemCount: perdidoListGato.length,
                    itemBuilder: (context, index) {
                      return FavoritosoneItemWidget(
                        perdido: perdidoListGato[index],
                      );
                    },
                  ),
                ),
