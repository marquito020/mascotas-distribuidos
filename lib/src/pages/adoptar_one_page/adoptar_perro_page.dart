...
class AdopcionPerroList extends StatefulWidget {
  const AdopcionPerroList({Key? key})
      : super(
          key: key,
        );

  @override
  AdopcionPerroListState createState() => AdopcionPerroListState();
}

class AdopcionPerroListState extends State<AdopcionPerroList>
    with AutomaticKeepAliveClientMixin<AdopcionPerroList> {
  @override
  bool get wantKeepAlive => true;
  List<Adopcion> adopcionListPeroo = [];
  @override
  Widget build(BuildContext context) {
    ...
    adopcionListPeroo = adopcionService.adopcioPerroList;
    print(adopcionListPeroo.length);
    super.build(context);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GridView.builder(
                    ...
                    itemCount: adopcionListPeroo.length,
                    itemBuilder: (context, index) {
                      return FavoritosoneItemWidget(
                        adopcion: adopcionListPeroo[index],
                      );
                    },
                  ),
                ),
