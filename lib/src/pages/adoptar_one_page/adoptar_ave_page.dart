...
class AdopcionAveList extends StatefulWidget {
  const AdopcionAveList({Key? key})
      : super(
          key: key,
        );

  @override
  AdopcionAveListState createState() => AdopcionAveListState();
}

class AdopcionAveListState extends State<AdopcionAveList>
    with AutomaticKeepAliveClientMixin<AdopcionAveList> {
  @override
  bool get wantKeepAlive => true;
  List<Adopcion> adopcionListAve = [];
  @override
  Widget build(BuildContext context) {
    ...
    adopcionListAve = adopcionService.adopcioAveList;
    print(adopcionListAve.length);
    super.build(context);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GridView.builder(
                    ...
                    itemCount: adopcionListAve.length,
                    itemBuilder: (context, index) {
                      return FavoritosoneItemWidget(
                        adopcion: adopcionListAve[index],
                      );
                    },
                  ),
                ),
