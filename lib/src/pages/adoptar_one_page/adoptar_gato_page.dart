...
class AdopcionGatoList extends StatefulWidget {
  const AdopcionGatoList({Key? key})
      : super(
          key: key,
        );

  @override
  AdopcionGatoListState createState() => AdopcionGatoListState();
}

class AdopcionGatoListState extends State<AdopcionGatoList>
    with AutomaticKeepAliveClientMixin<AdopcionGatoList> {
  @override
  bool get wantKeepAlive => true;
  List<Adopcion> adopcionListGato = [];
  @override
  Widget build(BuildContext context) {
    ...
    adopcionListGato = adopcionService.adopcioGatoList;
    print(adopcionListGato.length);
    super.build(context);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: GridView.builder(
                    ...
                    itemCount: adopcionListGato.length,
                    itemBuilder: (context, index) {
                      return FavoritosoneItemWidget(
                        adopcion: adopcionListGato[index],
                      );
                    },
                  ),
                ),
